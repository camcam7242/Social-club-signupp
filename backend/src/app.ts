...
app.use('/api/terminal', paymentLimiter, terminalRoutes);
app.use('/api/push', pushLimiter, pushRoutes);
app.use('/api/jobs/:jobId/chat', chatLimiter, chatRoutes);
app.use('/api/mechanics/documents', uploadLimiter, documentRoutes);
