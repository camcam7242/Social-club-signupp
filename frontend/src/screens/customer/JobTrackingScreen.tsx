...
const styles = StyleSheet.create({
  ...
  stepLabel: { fontSize: 15, color: '#64748b', fontWeight: '500' },
  stepLabelActive: { color: '#1a56db', fontWeight: '700', fontSize: 16 },
  stepLabelDone: { color: '#cbd5e1' },
  ...
  payTitle: { fontSize: 20, fontWeight: '700', color: '#f1f5f9', marginBottom: 6 },
  paySubtitle: { fontSize: 14, color: '#94a3b8', marginBottom: 20 },
  ...
  chatBtn: {
    backgroundColor: '#1e3a5f', borderWidth: 1.5, borderColor: '#1a56db',
    borderRadius: 12, padding: 14, alignItems: 'center', marginBottom: 16,
  },
  chatBtnText: { color: '#1a56db', fontWeight: '600', fontSize: 15 },
  receiptBtn: { marginTop: 10 },
  receiptBtnText: { color: '#cbd5e1', fontSize: 14, textAlign: 'center' },
  ...
  notesSectionTitle: { fontSize: 16, fontWeight: '700', color: '#f1f5f9', marginBottom: 10 },
  notesEmpty: { color: '#64748b', fontSize: 13, marginBottom: 10 },
  noteCard: {
    backgroundColor: '#0f172a', borderRadius: 10, padding: 12, marginBottom: 8,
    borderLeftWidth: 3, borderLeftColor: '#1a56db',
  },
  noteAuthor: { fontSize: 11, fontWeight: '700', color: '#94a3b8', marginBottom: 4 },
  noteText: { fontSize: 14, color: '#cbd5e1' },
  noteTime: { fontSize: 10, color: '#64748b', marginTop: 4 },
  ...
  noteInput: {
    ...
    fontSize: 14, color: '#f1f5f9', minHeight: 42,
  },
