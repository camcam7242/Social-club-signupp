...
const styles = StyleSheet.create({
  ...
  card: {
    backgroundColor: '#0f172a', borderRadius: 12, padding: 16, marginBottom: 16,
    shadowColor: '#000', shadowOpacity: 0.05, shadowRadius: 4, elevation: 2,
  },
  row: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 6 },
  serviceType: { fontSize: 20, fontWeight: '700', color: '#f1f5f9' },
  badge: { paddingHorizontal: 10, paddingVertical: 4, borderRadius: 20 },
  badgeText: { fontSize: 12, fontWeight: '600', textTransform: 'capitalize' },
  vehicle: { fontSize: 14, color: '#94a3b8', marginBottom: 8 },
  description: { fontSize: 15, color: '#cbd5e1', marginBottom: 8 },
  location: { fontSize: 13, color: '#94a3b8' },
  sectionTitle: { fontSize: 17, fontWeight: '700', color: '#f1f5f9', marginBottom: 12 },
  emptyQuotes: { backgroundColor: '#0f172a', borderRadius: 12, padding: 24, alignItems: 'center', marginBottom: 12 },
  emptyQuotesText: { color: '#94a3b8', fontSize: 14 },
  quoteCard: {
    backgroundColor: '#0f172a', borderRadius: 14, padding: 16, marginBottom: 12,
  ...
  mechanicName: { fontSize: 16, fontWeight: '700', color: '#f1f5f9', marginBottom: 4 },
  metaRow: { flexDirection: 'row', gap: 4 },
  metaText: { fontSize: 13, color: '#94a3b8' },
  priceBlock: { alignItems: 'flex-end' },
  quotePrice: { fontSize: 26, fontWeight: '800', color: '#1a56db' },
  quoteStatus: { fontSize: 13, color: '#64748b', fontWeight: '500', marginTop: 6 },
  quoteDuration: { fontSize: 12, color: '#64748b', marginTop: 2 },
  quoteNotes: { fontSize: 14, color: '#cbd5e1', marginBottom: 8, lineHeight: 20 },
  quoteExpiry: { fontSize: 11, color: '#64748b', marginBottom: 8 },
  acceptBtn: { backgroundColor: '#1a56db', borderRadius: 12, padding: 14, alignItems: 'center', marginTop: 4 },
  acceptBtnText: { color: '#fff', fontWeight: '700', fontSize: 15 },
  bestBadge: { backgroundColor: '#422006', borderRadius: 8, paddingHorizontal: 10, paddingVertical: 4, alignSelf: 'flex-start', marginBottom: 10 },
  bestBadgeText: { fontSize: 12, fontWeight: '700', color: '#fcd34d' },
