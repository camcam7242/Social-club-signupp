...
const styles = StyleSheet.create({
  ...
  locatingText: { marginTop: 12, color: '#6b7280', fontSize: 15 },
  ...
  sheetName: { fontSize: 17, fontWeight: '700', color: '#111' },
  ...
  sheetStatValue: { fontSize: 18, fontWeight: '700', color: '#111' },
  sheetStatLabel: { fontSize: 12, color: '#9ca3af', marginTop: 4 },
