...
const styles = StyleSheet.create({
  ...
  receiptTitle: { fontSize: 16, fontWeight: '700', color: '#111', marginBottom: 16 },
  receiptRow: { flexDirection: 'row', justifyContent: 'space-between', marginBottom: 8 },
  receiptLabel: { fontSize: 15, color: '#374151' },
  receiptValue: { fontSize: 15, color: '#374151', fontWeight: '500' },
  divider: { height: 1, backgroundColor: '#e5e7eb', marginVertical: 12 },
  receiptTotalLabel: { fontSize: 17, fontWeight: '700', color: '#111' },
  ...
  orText: { color: '#9ca3af', fontSize: 13 },
  cardBtn: {
  ...
  secureNote: { textAlign: 'center', color: '#9ca3af', fontSize: 13, marginTop: 20 },
});
