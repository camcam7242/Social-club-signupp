...
const styles = StyleSheet.create({
  ...
  backBtnText: { fontSize: 26, color: '#f1f5f9', marginTop: -2 },
  statusBar: {
  ...
  jobService: { fontSize: 17, fontWeight: '700', color: '#f1f5f9' },
  jobVehicle: { fontSize: 13, color: '#94a3b8', marginTop: 2 },
  ...
  mechanicName: { fontSize: 15, fontWeight: '600', color: '#f1f5f9' },
