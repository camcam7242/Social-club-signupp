...
const styles = StyleSheet.create({
  ...
  infoBox: { backgroundColor: '#1e3a5f', borderRadius: 12, padding: 14, marginBottom: 16 },
  ...
  blockInfo: { flex: 1 },
  blockDate: { fontSize: 15, fontWeight: '700', color: '#f1f5f9', marginBottom: 3 },
  blockTime: { fontSize: 13, color: '#94a3b8', marginBottom: 3 },
  blockReason: { fontSize: 12, color: '#64748b', fontStyle: 'italic' },
  deleteBtn: { padding: 8 },
  ...
  fieldLabel: { fontSize: 13, fontWeight: '600', color: '#cbd5e1', marginBottom: 6, marginTop: 10 },
  fieldInput: {
    borderWidth: 1.5, borderColor: '#334155', borderRadius: 10,
    padding: 12, fontSize: 15, backgroundColor: '#0f172a', color: '#f1f5f9',
  },
