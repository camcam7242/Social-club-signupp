...
const styles = StyleSheet.create({
  ...
  infoTitle: { fontSize: 14, fontWeight: '700', color: '#fcd34d', marginBottom: 6 },
  infoText: { fontSize: 13, color: '#fcd34d', lineHeight: 19 },
  uploadBtn: {
  ...
  docCard: {
    backgroundColor: '#0f172a', borderRadius: 12, padding: 16, marginBottom: 10,
    shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 4, elevation: 2,
  },
  docRow: { flexDirection: 'row', alignItems: 'center' },
  docInfo: { flex: 1 },
  docType: { fontSize: 14, fontWeight: '700', color: '#f1f5f9', marginBottom: 3 },
  docName: { fontSize: 13, color: '#94a3b8', marginBottom: 3 },
  docDate: { fontSize: 11, color: '#64748b' },
  deleteBtn: { padding: 8 },
  deleteBtnText: { fontSize: 20 },
  modalOverlay: { flex: 1, backgroundColor: 'rgba(0,0,0,0.5)', justifyContent: 'flex-end' },
  modalCard: { backgroundColor: '#0f172a', borderTopLeftRadius: 20, borderTopRightRadius: 20, padding: 24 },
  modalTitle: { fontSize: 20, fontWeight: '700', color: '#f1f5f9', marginBottom: 16 },
  modalLabel: { fontSize: 13, fontWeight: '600', color: '#cbd5e1', marginBottom: 10 },
  typeOption: {
    borderWidth: 1.5, borderColor: '#334155', borderRadius: 10,
    padding: 12, marginBottom: 8,
  },
  typeOptionActive: { borderColor: '#1a56db', backgroundColor: '#1e3a5f' },
  typeOptionText: { fontSize: 14, color: '#94a3b8' },
