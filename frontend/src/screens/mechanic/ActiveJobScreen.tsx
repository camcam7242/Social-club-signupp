...
const styles = StyleSheet.create({
  ...
  vehicle: { fontSize: 13, color: '#94a3b8', marginBottom: 4 },
  location: { fontSize: 13, color: '#94a3b8', marginBottom: 4 },
  price: { fontSize: 14, color: '#cbd5e1', fontWeight: '500', marginBottom: 12 },
  ...
  notesSectionTitle: { fontSize: 14, fontWeight: '700', color: '#cbd5e1', marginBottom: 6 },
  notesEmpty: { color: '#64748b', fontSize: 12, marginBottom: 8 },
  noteCard: {
    backgroundColor: '#0f172a', borderRadius: 8, padding: 8, marginBottom: 6,
    borderLeftWidth: 3, borderLeftColor: '#10b981',
  },
  noteAuthor: { fontSize: 10, fontWeight: '700', color: '#94a3b8', marginBottom: 2 },
  noteText: { fontSize: 13, color: '#cbd5e1' },
  addNoteRow: { flexDirection: 'row', gap: 6, marginTop: 6, alignItems: 'flex-end' },
  noteInput: {
    flex: 1, backgroundColor: '#0f172a', borderRadius: 8, padding: 8,
    fontSize: 13, color: '#f1f5f9', minHeight: 38,
  },
