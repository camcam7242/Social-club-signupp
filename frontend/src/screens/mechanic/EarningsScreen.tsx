...
const styles = StyleSheet.create({
  ...
  bestWeekLabel: { fontSize: 14, fontWeight: '700', color: '#92400e' },
  bestWeekValue: { fontSize: 22, fontWeight: '800', color: '#111', flex: 1 },
  bestWeekDate: { fontSize: 12, color: '#9ca3af' },
  chartCard: {
    backgroundColor: '#fff', borderRadius: 16, padding: 16, marginBottom: 12,
    shadowColor: '#000', shadowOpacity: 0.04, shadowRadius: 4, elevation: 2,
  },
  chartTitle: { fontSize: 15, fontWeight: '700', color: '#111', marginBottom: 16 },
  chart: { flexDirection: 'row', height: 140, alignItems: 'flex-end', gap: 6 },
  barCol: { flex: 1, alignItems: 'center', height: '100%', justifyContent: 'flex-end' },
  barValue: { fontSize: 8, color: '#9ca3af', marginBottom: 2 },
  ...
  barLabel: { fontSize: 8, color: '#9ca3af', marginTop: 4, textAlign: 'center' },
  breakdownCard: {
  ...
  serviceType: { fontSize: 13, fontWeight: '600', color: '#374151' },
  serviceRevenue: { fontSize: 12, color: '#9ca3af' },
  progressTrack: { height: 8, backgroundColor: '#f3f4f6', borderRadius: 4 },
