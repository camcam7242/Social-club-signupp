...
const styles = StyleSheet.create({
  ...
  banner: { backgroundColor: '#fef3c7', borderRadius: 10, padding: 14, marginBottom: 16 },
  ...
  availText: { fontSize: 15, color: '#111' },
  ...
  requestType: { fontSize: 15, fontWeight: '600', color: '#111' },
  requestVehicle: { fontSize: 13, color: '#6b7280', marginTop: 2 },
  requestDesc: { fontSize: 13, color: '#374151', marginTop: 4 },
